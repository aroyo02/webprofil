    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <!-- Dashboard -->
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('/') ? 'active fw-bold' : '' }}" href="{{ route('dashboardpublik') }}">Dashboard</a>
                </li>

                <!-- Dropdown Profil -->
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ Request::is('profilsekolah') || Request::is('visimisi') || Request::is('struktur-organisasi') || Request::is('daftarguru') ? 'active fw-bold' : '' }}"
                ...
                <!-- Dropdown Informasi -->
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ Request::is('ekstrakurikuler') || Request::is('saranaprasarana') ? 'active fw-bold' : '' }}"
                       href="#" id="infoDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        Informasi
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="infoDropdown">
                        ...
                        <li><a class="dropdown-item {{ Request::is('saranaprasarana') ? 'fw-bold text-primary' : '' }}" href="{{ route('sarpras') }}">Sarpras</a></li>
                    </ul>
                </li>

                <!-- Galeri -->
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('galeri') ? 'active fw-bold' : '' }}" href="{{ route('galeri') }}">Galeri</a>
                </li>
